...
<body>
	...
	<div style="text-align: center;font-family: Helvetica;" align="center" id="suave">
                        Por favor espere unos segundos mientras validamos tu acceso. <strong id="time"><br><label id="countdown">0:10</label></strong></div><strong id="time">
